...
# 调用 C# 类中的方法
#DataDriverCrm.crmConnectionString = "AuthType=AD;Server=http://121.33.201.38:10005/bain;Domain=BAINDEV;UserName=crmadmin;Password=BAin@202403"
#name = DataDriverCrm.excute("account")
#print(name)

#d = DriverSqlServer()
#d.server = "dev1.crm5.dynamics.com"
#d.port = "1433"
#d.username = "gw_dengzh@sanyglobal.onmicrosoft.com"
#d.password = "Rektec2025"
#d.init_engine()
#d.get_session()
